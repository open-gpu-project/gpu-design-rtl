...
always @(GSR) begin
  if (GSR) begin
    // Drive initial/reset values into the procedural regs while GSR is asserted
  ...
  // When GSR is deasserted, do not override these regs here so other procedural drivers can update them.
end
