...
//*********************************************************
    ...
    generate 
       case (A_INPUT)
          "DIRECT"  : always @(a_in)  begin 
           a_o_mux = a_in;
          // $display("%t DIRECT a_o_mux[24:0] %d a_in[24:0] %d",$time,a_o_mux[24:0],a_in[24:0]);
          end
          ...
          1 : begin
           ...
           if (rsta_in) begin
                    ...
                    qa_o_reg2 <= 30'b0;
                      ...
                      if (cea2_in)
                          qa_o_reg2 <= a_o_mux;
                      //$display("%t qa_o_reg1 %d qa_o_reg2 %d",);
                 end
              end
          end
...
// else
  case (qopmode_o_mux[1:0])
              2'b00 : begin qx_o_mux <= 48'b0; end
...
//ALUMODE = 0000 ѡ�����Z + (X + Y + CIN)�����Ӳ�����

//ALUMODE = 0011 ѡ��Z - (X + Y + CIN)��ʽ�ļ����㡣

//ALUMODE = 0001 ����ʵ��- z + (X + Y + CIN) - 1 = not (Z) + X + Y + CIN��
